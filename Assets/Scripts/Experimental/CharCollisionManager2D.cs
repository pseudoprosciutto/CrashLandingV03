...
namespace CL03.Experimental
{
    ...
    public class CharCollisionManager2D : MonoBehaviour
    {
        ...
        /// </summary>
        /// <returns>boundsMinusSkinWidth</returns>
        private Bounds GetBoundsWithoutSkinWidth()
        {
            //get bounds of collider
            Bounds bounds = collider.bounds;
            return bounds;
        ...
        /// <summary>
        /// Get Center of Box Raycasts
        /// </summary>
        protected void UpdateBoxcastOrigin()
        {
            Bounds bounds = GetBoundsWithoutSkinWidth();
        ...
        /// </summary>
        protected void CheckHorizontalCollisions(ref Vector2 displacement)
        {
        ...
        /// </summary>
       protected void CheckVerticalCollisions(ref Vector2 displacement)
        {
...
**/
        ...
        /// </summary>
       protected void CheckSlopeAscent(ref Vector2 displacement, float slopeAngle)
        {
        ...
        /// </summary>
        protected void CheckSlopeDescent(ref Vector2 displacement)
        {
