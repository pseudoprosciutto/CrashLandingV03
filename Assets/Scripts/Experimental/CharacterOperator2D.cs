...
//	[RequireComponentInParent (typeof(InputManager))]
    ...
    public class CharacterOperator2D : MonoBehaviour
    {
        InputManager input;
        ...
        #region CharacterPhysics2D operations
        void GravityForce()
        {
        ...
        /// <summary> This will set isSelected to opposite property </summary>
        public void SetSelected() => isSelected = !isSelected;
        /// <summary> This will set the selected property by passing bool </summary><param name="_">bool isSelected?</param>
        public void SetSelected(bool _) => isSelected = _;
        #endregion
    }
}
