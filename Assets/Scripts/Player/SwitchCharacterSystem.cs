    ...
    public class SwitchCharacterSystem : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            for (int i = 0; i < Characters.Length; i++)
            {
                ...
                if (Characters[i].TryGetComponent(out CharManager2D _charControl))
                    _charControl.enabled = true;
                else
                    _charControl.GetComponent<CharManager2D>().enabled = false;
        ...
        void Start()
        {
            ...
            CharManager2D firstCharacter = currentChar.GetComponent<CharManager2D>();
        ...
        private void ChangeChar(GameObject newSelectedChar)
        {
            ...
            var oldChar = currentChar.GetComponent<CharManager2D>();
            input.ClearForCharChange();
...
//            oldChar.OnCharacterChange_End();
            ...
            var newChar = currentChar.GetComponent<CharManager2D>();
